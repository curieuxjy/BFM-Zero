...
| `study/scripts/compare_three_inferences.py` | **3가지 inference 모드 심층 비교** (z 계산 과정 시각화) | `uv run python study/scripts/compare_three_inferences.py --model_folder model/` |

### compare_three_inferences.py 상세 사용법
...
uv run python study/scripts/compare_three_inferences.py --step 1
...
# 다른 모션으로 실행
uv run python study/scripts/compare_three_inferences.py --model_folder model/ --motion_id 0 --frame_idx 50
```
